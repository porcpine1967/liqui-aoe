...
def test_tournaments(tournament_manager):
    ...
    assert tournaments[13].start == datetime(2021, 12, 13)
    assert tournaments[13].end == datetime(2022, 2, 20)
    assert tournaments[18].start == tournaments[18].end == datetime(2022, 2, 8)
